...
class ParkingAdminModal extends Component {
	render() {
		const { openFormModal, toggleModal, options, invalid, pristine, loadingSubmit, handleSubmit, onSubmit, initialValues } = this.props;
		return (
			<Modal
				size="tiny"
				open={openFormModal}
				...
				<Modal.Header>
					<div style={{ display: 'flex', flexDirection: 'row' }}>
						<div style={{ marginRight: 'auto' }}>
							<Header as="h5">Parking App Admin</Header>
						</div>
						<div>
							<Icon
								name="delete"
							...
							<Grid.Row style={{ padding: '15px 15px 0px 15px' }}>
								<Form.Group widths="equal">
									...
									<Form.Field>
										...
										/>
										<label><small style={{ marginLeft: '15px', color: '#999', fontSize: '10px' }}>Username</small></label>
									</Form.Field>
								</Form.Group>
							</Grid.Row>
								...
								<Form.Group widths="equal">
									<Form.Field>
										<Field
											component={renderFormInput}
											type="password"
											validate={!initialValues ? [validateRequired] : []}
											name="password"
											placeholder="Password"
										/>
										<label><small style={{ marginLeft: '15px', color: '#999', fontSize: '10px' }}>Password</small></label>
									</Form.Field>
									<Form.Field>
										<Field
											component={renderFormInput}
											type="password"
											validate={!initialValues ? [validateRequired, validateMatchPassword] : [validateMatchPassword]}
											name="passwordConfirmation"
											placeholder="Confirm Password"
										/>
										<label><small style={{ marginLeft: '15px', color: '#999', fontSize: '10px' }}>Confirm Password</small></label>
									</Form.Field>
								</Form.Group>
							</Grid.Row>
							<Grid.Row style={{ padding: '15px 15px 0px 15px' }}>
...
export default ParkingAdminModal;
